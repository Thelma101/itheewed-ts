...
const FeaturesCard: React.FC = () => {
 ...
 <section className="w-full my-0">
  <div className="mx-auto px-4 py-20 bg-[#FFFFE4]">
    <div className="flex flex-col lg:flex-row gap-10 justify-center items-stretch text-center">
      
      <div className="flex-1 p-5 bg-white rounded-xl shadow">
        <h1 className="font-bold text-xl mb-2">Shop Wedding Essentials</h1>
        <p className="mb-4">
          Access your favourite wedding accessories from vetted vendors near you, all in one place — no stress, just style.
        </p>
        <button className="bg-[#EB1948] text-white px-8 py-3 rounded-3xl">Try Now</button>
      </div>
